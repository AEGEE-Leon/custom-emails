function sendPersonalizedEmails() {
    ...
    const fileId = getFileIdFromUrl(
        "https://docs.google.com/spreadsheets/d/1XqIG72AfEoRAZmV7sppI_jsauBXUjBxZgjHzhS7c_ME/edit?gid=2089639173#gid=2089639173"
    );
    const sheetName = "Lista Erasmus 24/25";
    ...
    const headers = data[1]; // encabezados
