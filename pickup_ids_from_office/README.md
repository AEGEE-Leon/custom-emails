# “Pick Up Your Card” Script (Google Apps Script)

## What it does

This script iterates over a Google Sheets file and **sends a bilingual (Spanish / English) HTML email** to each member **whose card is still pending** to pick up from the office (`Pendiente tarjeta` = TRUE).
